...
// console.log(extendNavbar);
  ...
  return (
    <div className={`flex justify-between lg:items-center items-start bg-gray-400 duration-500 lg:h-28  ${extendNavbar ? "h-96" : " h-28"}`}>
...
<div className={`text-2xl font-semibold items-center gap-6 flex flex-col justify-center lg:flex-row absolute top-32 lg:static duration-500 ${extendNavbar ? "left-10" : "left-[-100px] top-[-100px]"}`} >
